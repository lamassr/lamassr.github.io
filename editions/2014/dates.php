...
<ul><ul>  <li><a class = "noactive" href = "index.php"><strong>About SR 2014</strong></a></li>
  ...
  <li><a class = "noactive" href = "../../editions.php">Edition archive</a></li>
    ...
    <div id = "content">
				...
				<ul>
					<li>
						<strong>November 1st, 2013</strong>: Submission opening
					</li>
				</ul>

				<ul>
					<li>
						<strong>December 27th, 2013</strong> (strict): Abstract submission deadline
						(<a href = "http://en.wikipedia.org/wiki/Anywhere_on_Earth">AoE</a>)
					</li>
					<li>
						<strong>December 30th, 2013</strong> (strict): Contribution submission deadline
						(<a href = "http://en.wikipedia.org/wiki/Anywhere_on_Earth">AoE</a>)
					</li>
				</ul>
				...
				<ul>
					<li>
						<strong>January 30th, 2014</strong>: Acceptance notification
					</li>
					<li>
						<strong>February 10th, 2014</strong>: Camera-ready version deadline
						(<a href = "http://en.wikipedia.org/wiki/Anywhere_on_Earth">AoE</a>)
					</li>
				</ul>
				...
				<ul>
					<li>
						<strong>April 5th-6th, 2014</strong>: SR 2014 workshop
					</li>
				</ul>
