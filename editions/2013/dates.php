...
<ul><ul>  <li><a class = "noactive" href = "index.php"><strong>About SR 2013</strong></a></li>
  ...
  <li><a class = "noactive" href = "../../editions.php">Edition archive</a></li>
    ...
    <div id = "content">
				...
				<ul>
					<li>
						<strong>November 1st, 2012</strong>: Submission opening
					</li>
				</ul>

				<ul>
					<li>
						<strong>December 21st, 2012</strong> (strict): Abstract submission deadline
						(<a href = "http://en.wikipedia.org/wiki/Anywhere_on_Earth">AoE</a>)
					</li>
					<li>
						<strong>December 27th, 2012</strong> (strict): Contribution submission deadline
						(<a href = "http://en.wikipedia.org/wiki/Anywhere_on_Earth">AoE</a>)
					</li>
				</ul>
				...
				<ul>
					<li>
						<strong>January 23rd, 2013</strong>: Acceptance notification
					</li>
					<li>
						<strong>February 8th, 2013</strong>: Camera-ready version deadline
						(<a href = "http://en.wikipedia.org/wiki/Anywhere_on_Earth">AoE</a>)
					</li>
				</ul>
				...
				<ul>
					<li>
						<strong>March 16th-17th, 2013</strong>: SR 2013 workshop
					</li>
				</ul>
