...
<ul><ul>  <li><a class = "noactive" href = "index.php"><strong>About SR 2013</strong></a></li>
  ...
  <li><a class = "noactive" href = "../../editions.php">Edition archive</a></li>
    ...
    <div id = "content">
				...
				<p>
					The <em>SR international workshop</em> will take place in <em>Room C</em> of the <em>"Dipartimento di Scienze
					Odontostomatologiche e Maxillo-Facciali"</em> of Sapienza, University of Rome.
					The department has two entrance, the official one in <em>via Caserta 6</em> and a secondary one in <em>viale
					Regina Margherita 287/A</em>.
				</p>

				<p>
					The <em>social dinner</em> of the workshop will be held at the <em>Ristorante "La Naumachia"</em> in <em>via
					Celimontana, 7</em>.
				</p>

				<p>
					Further and more detailed information can be found on the ETAPS 2013
					<a href = "http://www.etaps.org/2013/venue/">venues</a> page.
				</p>
