...
<ul><ul>  <li><a class = "noactive" href = "index.php"><strong>About SR 2013</strong></a></li>
  ...
  <li><a class = "noactive" href = "../../editions.php">Edition archive</a></li>
    ...
    <div id = "content">
				...
				<p>
					The proceedings of this edition of the <em>SR international workshop</em> are now available through the
					specific <a href = "http://rvg.web.cse.unsw.edu.au/eptcs/content.cgi?SR">SR 2013</a> webpage of the
					<a href = "http://about.eptcs.org/">Electronic Proceedings in Theoretical Computer Science (EPTCS)</a>
					webportal.
					A single pdf file of the proceedings book can be also download here:
					<a href = "sr2013.pdf">sr2013.pdf</a>.
				</p>
